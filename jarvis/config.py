...
# This key will only be used if OPENAI_API_KEY is not set in the environment
OPENAI_API_KEY = "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"
